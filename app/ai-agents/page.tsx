    ...
    return (
        <div className="min-h-screen bg-black text-white selection:bg-orange-500 selection:text-white">
            ...
            <main className="pt-32 md:pt-48 pb-20 px-6 lg:px-8 max-w-7xl mx-auto">
                ...
                {/* Video Showcase */}
                <div className="relative w-full aspect-video rounded-3xl overflow-hidden glass-effect border border-white/10 shadow-2xl group mb-20">
                    {/* Ambient Glow */}
                    <div className="absolute -inset-1 bg-gradient-to-r from-orange-600 to-purple-600 rounded-3xl blur-xl opacity-20 group-hover:opacity-40 transition duration-1000"></div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {/* Feature 1 */}
                    <div className="glass-effect p-8 rounded-2xl border border-white/10 hover:border-orange-500/50 transition-all duration-300 transform hover:scale-105">
                        ...
                        <p className="text-gray-400 leading-relaxed">Agents operate independently 24/7, handling complex workflows without human intervention or oversight.</p>
                    </div>
                    {/* Feature 2 */}
                    <div className="glass-effect p-8 rounded-2xl border border-white/10 hover:border-orange-500/50 transition-all duration-300 transform hover:scale-105">
                        <div className="w-14 h-14 bg-orange-500/20 rounded-xl flex items-center justify-center mb-6 text-orange-400 border border-orange-500/30">
                        ...
                        <p className="text-gray-400 leading-relaxed">Understand intent and nuance in data, allowing for smarter decision making and personalized responses.</p>
                    </div>
                    {/* Feature 3 */}
                    <div className="glass-effect p-8 rounded-2xl border border-white/10 hover:border-orange-500/50 transition-all duration-300 transform hover:scale-105">
                        <div className="w-14 h-14 bg-orange-500/20 rounded-xl flex items-center justify-center mb-6 text-orange-400 border border-orange-500/30">
                        ...
                        <p className="text-gray-400 leading-relaxed">Process text, images, and data streams simultaneously for comprehensive analysis and output generation.</p>
                    </div>
                </div>
